...
class TimerStateTest {
    @Test
    fun startTest() {
        val timerState = TimerState.Unload
    ...
    fun pauseTest_beforeStart() {
        val timerState = TimerState.Unload.copy(isRunning = true)
    ...
    @Test
    fun tickTest() {
        val timerState = TimerState.Unload.copy(isRunning = true, remainSeconds = 10)
    ...
    @Test
    fun tickTest_0sec() {
        val timerState = TimerState.Unload.copy(isRunning = true, remainSeconds = 0)
    ...
    fun totalDurationTest() {
        val timerState = TimerState.Unload.copy(isRunning = true, totalSeconds = 10)
        assert(timerState.totalDuration == Duration(0, 10))
    }

    @Test
    fun percentageTest() {
        val timerState = TimerState.Unload.copy(isRunning = true, remainSeconds = 10, totalSeconds = 20)
